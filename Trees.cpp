...
public:
    ...
    void inorderTraversal() { cout<<endl;cout<<"************* In Order Traversal ************\n"; inorder (this->root);}
    void preorderTraversal() { cout<<endl; cout<<"************* Pre-Order Traversal ************\n";preorder (this->root);}
    void postorderTraversal() { cout<<endl; cout<<"************* Post-Order Traversal ************\n"; postorder (this->root);}
...
//cout<<endl;
//cout<<"\n Searching element : 29";//<<chk;
//int p = 29;
//cout<<"\n Found? : "<<mystree->searchNode(p);
// /*
